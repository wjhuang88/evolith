...
-- ============================================
-- Usage records table (for overage billing)
-- ============================================
...
-- ============================================
-- Plans table (normalized from enum)
-- ============================================
...
-- Insert built-in plans
INSERT INTO plans (id, name, display_name, description, monthly_price, yearly_price, max_users, max_tools, max_skills, max_snippets, max_api_calls_per_month, max_storage_mb, features, sort_order) VALUES
