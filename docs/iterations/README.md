...
| Iteration | 状态 | 目标/处置 |
|-----------|------|-----------|
| [Iteration 051](ITERATION-051.md) | Active | EVO-118-B：API Key Owner/Admin 管理、Typed Capability、MCP `execute` scope 与负向测试 |
...
- Iteration 051 是唯一 Active Story；WIP 只推进 EVO-118-B。
- 051 关闭后默认进入 EVO-118-C，不直接激活 Repo UI。
