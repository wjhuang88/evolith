...
4. [Iteration 051](iterations/ITERATION-051.md) — 当前唯一 Active WIP：API Key 与 MCP 授权边界硬化。
...
> 当前顺序：EVO-118-B → C → D → E → F/G/H → EVO-112 → Agent/Vibe/Indexer 主线。原 Two-Month Plan 保留为历史计划基线，不再作为当前激活顺序。
...
- [EVO-118-B](backlog/active/EVO-118-B-api-key-mcp-authorization-hardening.md) — 当前安全 Story。
