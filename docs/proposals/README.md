...
| 事项 | 状态 | 下一步 |
|------|------|--------|
| API gap checkpoint | 已晋升 | 已沉淀到 [实施路线图](../roadmap/IMPLEMENTATION-ROADMAP.md) 和 [Product Backlog](../backlog/PRODUCT-BACKLOG.md) |
| Database migration SOP | 已晋升 | 已落地为 [数据库迁移 SOP](../sop/DATABASE-MIGRATION.md) |
