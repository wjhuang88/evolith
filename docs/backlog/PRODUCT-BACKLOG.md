...
| EVO-103-A | Repo CRUD（gix::init + RBAC） | In Progress | P0 | EVO-103 子 Story；依赖 EVO-101（Done）；gix crate（EVO-086 Done）；ITERATION-044 | [Item file](active/EVO-103-A-repo-crud.md)<br>[ADR-0004](../decisions/ADR-0004-git-centric-storage.md)<br>[EVO-101](active/EVO-101-git-repos-schema.md) |
| EVO-103-B | Smart HTTP git 协议（clone/push/pull） | Proposed | P0 | EVO-103 子 Story；硬依赖 EVO-103-A | [Item file](active/EVO-103-B-smart-http-git-protocol.md)<br>[ADR-0004](../decisions/ADR-0004-git-centric-storage.md)<br>[EVO-103-A](active/EVO-103-A-repo-crud.md) |
