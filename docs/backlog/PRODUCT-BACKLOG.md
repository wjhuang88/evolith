...
| EVO-118-H-C | Durable Push Event 业务接入 | Done / Complete | P1 | Iteration 068 Closed；producer/subscriber、双数据库与完整 Smart HTTP E2E 闭合 | [Item file](active/EVO-118-H-C-durable-push-event-integration.md)<br>[Parent H](active/EVO-118-H-durable-outbox-events.md)<br>[Iteration 068](../iterations/ITERATION-068.md)<br>[Security Review](../sop/SECURITY-REVIEW.md) |
...
| EVO-118-H | Epic: Durable Outbox 与可靠事件交付 | Done / Complete | P1 | H-A/B/C 全部 Done；EVENT-01 Durable Outbox 基础 Gate 解除 | [Item file](active/EVO-118-H-durable-outbox-events.md)<br>[H-A](active/EVO-118-H-A-recoverable-outbox-claims.md)<br>[H-B](active/EVO-118-H-B-outbox-worker-runtime.md)<br>[H-C](active/EVO-118-H-C-durable-push-event-integration.md) |
...
| EVO-118-H-C | Durable Push Event 业务接入 | Done / Complete | P1 | Iteration 068 Closed；完整 Git E2E 连续 3/3 通过，EVO-125 已关闭 | [Item file](active/EVO-118-H-C-durable-push-event-integration.md)<br>[Iteration 068](../iterations/ITERATION-068.md)<br>[EVO-125](active/EVO-125-git-smart-http-e2e-hang.md) |
...
| EVO-125 | Git Smart HTTP E2E 偶发阻塞 | Done / Complete | P1 | bounded async Git runner；完整 clone/push/pull 聚焦 E2E 连续 3/3 通过 | [Item file](active/EVO-125-git-smart-http-e2e-hang.md)<br>[Testing SOP](../sop/TESTING.md) |
