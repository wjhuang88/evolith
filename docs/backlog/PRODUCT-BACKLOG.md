...
| EVO-118-H-C | Durable Push Event 业务接入 | Review / Partial | P1 | Iteration 068；核心 producer/subscriber 与双数据库证据通过；EVO-125 pull clone 认证失败残余 | [Item file](active/EVO-118-H-C-durable-push-event-integration.md)<br>[Parent H](active/EVO-118-H-durable-outbox-events.md)<br>[Iteration 068](../iterations/ITERATION-068.md)<br>[Security Review](../sop/SECURITY-REVIEW.md) |
...
| EVO-118-H-C | Durable Push Event 业务接入 | Review / Partial | P1 | Iteration 068；核心迁移完成，完整 Git E2E 认证残余归 EVO-125 | [Item file](active/EVO-118-H-C-durable-push-event-integration.md)<br>[Iteration 068](../iterations/ITERATION-068.md)<br>[EVO-125](active/EVO-125-git-smart-http-e2e-hang.md) |
