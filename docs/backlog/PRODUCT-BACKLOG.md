...
> **2026-08-03 生产就绪进展**：Git Service 基础已完成，API Key/MCP 授权与 HTTP Tool SSRF 两项安全 Gate 已关闭；[EVO-118-D](active/EVO-118-D-git-storage-durability-and-recovery.md) 在 [Draft PR #7](https://github.com/wjhuang88/evolith/pull/7) / Iteration 053 中处于 Navigator Blocked / Remediation。两个 DATA-01 blocker 已整改并通过最新 exact-head required CI，仍等待原独立 Navigator 对最新 Head re-review；DATA-01 保持 Open，EVO-118-E 保持 Ready / Not Started。事实口径见 [Production Readiness Baseline](../reference/PRODUCTION-READINESS-BASELINE.md)，执行顺序见 [Production Readiness Plan](../roadmap/PRODUCTION-READINESS-PLAN-2026-07.md)。EVO-112-A 的历史成果恢复不改变该优先顺序。

## Current Priorities

| ID | Title | Status | Priority | Decision Context | Required Reads |
| --- | --- | --- | --- | --- | --- |
| EVO-118-D | Git 存储持久化、备份与恢复演练 | In Progress / Navigator Blocked / Remediation | P0 | Iteration 053 Active；DATA-01 release blocker；最新整改 Head required CI 已通过，保持 Draft 等待独立 Navigator re-review | [Item file](active/EVO-118-D-git-storage-durability-and-recovery.md)<br>[Draft PR #7](https://github.com/wjhuang88/evolith/pull/7)<br>[Navigator Review Packet](../review/EVO-118-D-navigator-review.md)<br>[Release SOP](../sop/RELEASE.md)<br>[Baseline](../reference/PRODUCTION-READINESS-BASELINE.md) |
...
| EVO-118-D | Git 存储持久化、备份与恢复演练 | In Progress / Navigator Blocked / Remediation | P0 | Iteration 053 Active；DATA-01 Open；最新整改 Head required CI 已通过，等待独立 Navigator re-review | [Item file](active/EVO-118-D-git-storage-durability-and-recovery.md)<br>[Draft PR #7](https://github.com/wjhuang88/evolith/pull/7)<br>[Navigator Review Packet](../review/EVO-118-D-navigator-review.md) |
