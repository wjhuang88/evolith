...
| EVO-104 | Vibe Coding Web UI | Proposed | P0 | Epic EVO-100 配套 Story（前端）; 三栏（file tree + editor + chat panel）；依赖 EVO-103/105/106/112；UX 调研前置门禁已解除，仍等待 API / 基础 UI 依赖 | [Item file](active/EVO-104-vibe-coding-web-ui.md)<br>[Design Decisions](../design/vibe-coding-ui-decisions.md)<br>[Design System](../reference/DESIGN.md) |
