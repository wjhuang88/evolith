...
> **2026-08-04 生产就绪进展**：Git Service 基础已完成，API Key/MCP 授权与 HTTP Tool SSRF 两项安全 Gate 已关闭；[EVO-118-D](active/EVO-118-D-git-storage-durability-and-recovery.md) 在 [Draft PR #7](https://github.com/wjhuang88/evolith/pull/7) / Iteration 053 中处于第三次 Navigator Blocked / Remediation。此前 finding 全部 Resolved，当前整改 Subscription credential archive boundary 与 production `psql -X` startup isolation；Head `551e713...` 的绿色 workflow 仅为历史证据。DATA-01 保持 Open，EVO-118-E 保持 Ready / Not Started。事实口径见 [Production Readiness Baseline](../reference/PRODUCTION-READINESS-BASELINE.md)，执行顺序见 [Production Readiness Plan](../roadmap/PRODUCTION-READINESS-PLAN-2026-07.md)。EVO-112-A 的历史成果恢复不改变该优先顺序。

## Current Priorities

| ID | Title | Status | Priority | Decision Context | Required Reads |
| --- | --- | --- | --- | --- | --- |
| EVO-118-D | Git 存储持久化、备份与恢复演练 | In Progress / Navigator Blocked / Remediation | P0 | Iteration 053 Active；DATA-01 release blocker；第三次整改 Subscription credential 与 hostile `PSQLRC`，新提交后必须重跑 exact-head required CI 并独立 re-review | [Item file](active/EVO-118-D-git-storage-durability-and-recovery.md)<br>[Draft PR #7](https://github.com/wjhuang88/evolith/pull/7)<br>[Navigator Review Packet](../review/EVO-118-D-navigator-review.md)<br>[Release SOP](../sop/RELEASE.md)<br>[Baseline](../reference/PRODUCTION-READINESS-BASELINE.md) |
| EVO-118-E | Embedded Frontend 生产构建与部署收敛 | Ready | P0 | DEPLOY-01 release blocker；clean build、单一交付形态、协议路径 Smoke Test；EVO-118-D 闭环前不启动 | [Item file](active/EVO-118-E-production-build-deployment-convergence.md)<br>[Release SOP](../sop/RELEASE.md)<br>[Readiness plan](../roadmap/PRODUCTION-READINESS-PLAN-2026-07.md) |
...
| ID | Title | Status | Priority | Decision Context | Required Reads |
| --- | --- | --- | --- | --- | --- |
| EVO-118 | Epic: Production Readiness and Security Hardening | In Progress | P0 | Phase E'-1 与 Repo UI/Agent 集成之间的稳定化门禁；A/B/C Done，D 在 PR #7 Navigator Remediation，E Ready / Not Started，F~H Proposed | [Item file](active/EVO-118-production-readiness-and-security-hardening.md)<br>[Baseline](../reference/PRODUCTION-READINESS-BASELINE.md)<br>[Readiness plan](../roadmap/PRODUCTION-READINESS-PLAN-2026-07.md) |
...
| EVO-118-D | Git 存储持久化、备份与恢复演练 | In Progress / Navigator Blocked / Remediation | P0 | Iteration 053 Active；DATA-01 Open；第三次 Navigator blocker 正在整改，保持 Draft，等待新 exact-head workflows 与独立 re-review | [Item file](active/EVO-118-D-git-storage-durability-and-recovery.md)<br>[Draft PR #7](https://github.com/wjhuang88/evolith/pull/7)<br>[Navigator Review Packet](../review/EVO-118-D-navigator-review.md) |
| EVO-118-E | Embedded Frontend 生产构建与部署收敛 | Ready / Not Started | P0 | 解除 DEPLOY-01；不得在 EVO-118-D 闭环前自动启动 | [Item file](active/EVO-118-E-production-build-deployment-convergence.md) |
